...
Descripción:
Este programa, elaborado con la biblioteca Tkinter de Python, ofrece una interfaz visual sencilla donde el usuario puede ingresar su nombre y recibir un mensaje de saludo. La ventana incluye campos para entrada de texto, botones con funcionalidades interactivas y uso de ventanas emergentes (messagebox) para mostrar mensajes.
Se implementaron principios de diseño accesible y pruebas unitarias para asegurar la correcta operación del sistema.
